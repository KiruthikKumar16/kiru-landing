...
export const Route = createFileRoute("/smart-packing")({
...
const OVERVIEW_BLOCKS = [
  {
    title: "Overview",
    body:
      "Packing is often a balance between preparation and uncertainty. Many travelers bring too much, only to wear a fraction of what they packed, while others leave behind essentials they later wish they had. Kiru's Smart Packing system removes the guesswork by transforming outfit recommendations into efficient packing lists tailored to your destination, itinerary, and wardrobe. Every item earns its place, ensuring you're prepared without carrying unnecessary weight.",
  },
  {
    title: "Optimized for Versatility",
    body:
      "The smartest suitcase isn't the fullest one. Kiru identifies clothing that can be worn across multiple days, activities, and occasions, maximizing outfit possibilities while minimizing the number of items you need to bring. By focusing on versatility, every garment contributes to a more efficient and flexible travel wardrobe.",
  },
  {
    title: "Tailored to Every Destination",
    body:
      "A beach vacation, business conference, and mountain retreat all require different packing strategies. Kiru analyzes weather forecasts, seasonal conditions, planned activities, and destination-specific needs to determine exactly what belongs in your suitcase. Every recommendation is personalized to the journey ahead.",
  },
  {
    title: "Confidence Before Departure",
    body:
      "Knowing you've packed everything you need brings peace of mind before every trip. Kiru generates organized packing lists that include clothing, footwear, accessories, and travel essentials, helping you leave home with confidence. Whether you're traveling for a weekend or several weeks, your suitcase remains purposeful, organized, and ready for the adventure ahead.",
  },
];
...
const SLIDES = [
  {
    ...
    caption:
      "Generate personalized packing lists built around your destination, itinerary, and wardrobe.",
    image:
  ...
  {
    section: "Section 02",
    title: "Maximum Outfit Variety",
    caption:
      "Create more outfit combinations with fewer garments through intelligent selection.",
    image:
  ...
  {
    section: "Section 03",
    title: "Weather-Aware Essentials",
    caption:
      "Pack the right clothing for changing conditions before you leave home.",
    image:
      "https://images.unsplash.com/photo-1521334884684-d80222895322?auto=format&fit=crop&w=1400&q=80",
  ...
  },
  {
    ...
    caption:
      "Know exactly what to bring and why every item belongs in your suitcase.",
    image:
      "https://images.unsplash.com/photo-1512436991641-6745cdb1723f?auto=format&fit=crop&w=1400&q=80",
