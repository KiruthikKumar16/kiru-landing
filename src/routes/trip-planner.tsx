...
const OVERVIEW_BLOCKS = [
  {
    title: "Overview",
    body:
      "Every destination is unique, and so is every itinerary. Kiru's Trip Planner transforms your travel plans into a personalized styling experience by combining your destination, travel dates, planned activities, and wardrobe. From departure to your return home, every day is thoughtfully planned, ensuring you always know what to wear and what to pack before your journey begins.",
  },
  {
    title: "Built Around Your Itinerary",
    body:
      "No two trips follow the same schedule. Whether you're attending business meetings, exploring historic landmarks, relaxing at the beach, or enjoying an evening dinner, Kiru creates outfit recommendations that match every activity on your itinerary. Every day is planned individually, giving you confidence for every moment of your journey.",
  },
  {
    title: "Destination Intelligence",
    body:
      "Every destination brings different climates, cultures, and expectations. Kiru analyzes your chosen location using weather forecasts, seasonal conditions, and local insights to recommend clothing that's comfortable, appropriate, and ready for the experiences ahead. From tropical islands to snowy mountains, every recommendation is tailored to where you're going.",
  },
  {
    title: "Smarter Travel Preparation",
    body:
      "Planning doesn't end with choosing outfits. Kiru automatically transforms your itinerary into an optimized packing list, helping you avoid overpacking while ensuring every essential item is included. By selecting versatile clothing that works across multiple days and occasions, your suitcase becomes lighter, more organized, and ready for every adventure.",
  },
];
...
const SLIDES = [
  {
    ...
    caption:
      "Plan every destination, travel date, and activity in one seamless timeline.",
    image:
  ...
  },
  {
    ...
    caption:
      "Receive personalized outfit recommendations for every day of your journey.",
    image:
  ...
  },
  {
    ...
    caption:
      "Weather forecasts, seasonal conditions, and cultural guidance shape every recommendation.",
    image:
      "https://images.unsplash.com/photo-1521334884684-d80222895322?auto=format&fit=crop&w=1400&q=80",
  ...
  {
    section: "Section 04",
    title: "Optimized Packing",
    caption:
      "Transform your travel plans into an efficient packing list with only the essentials.",
    image:
      "https://images.unsplash.com/photo-1512436991641-6745cdb1723f?auto=format&fit=crop&w=1400&q=80",
