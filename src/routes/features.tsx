    ...
    >
      <div className="space-y-24 w-full">
        <div className="w-full">
          ...
          >
            <span className="block">Explore the technologies and experiences that make</span>
            <span className="block">Kiru your personal AI-powered travel stylist</span>
          </h3>
        </div>
...
function ClosingBanner() {
  return (
    <section id="download" className="relative h-[70svh] min-h-[480px] w-full overflow-hidden">
      <img
        src="https://images.unsplash.com/photo-1523381294911-8d3cead13475?auto=format&fit=crop&w=2400&q=85"
