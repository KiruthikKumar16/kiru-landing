...
function Hero() {
  return (
    <section id="top" className="relative h-[100svh] min-h-[560px] w-full overflow-hidden">
      <img
        src="https://images.unsplash.com/photo-1540574163026-643ea20ade25?auto=format&fit=crop&w=2400&q=85"
        alt="Shopping for clothes in a boutique"
...
const OVERVIEW_BLOCKS = [
  {
    title: "Overview",
    body:
      "The best outfit often starts with the clothes you already own. Kiru's Shopping Assistant is designed to recommend new pieces only when they're truly needed, helping you fill gaps in your wardrobe rather than encouraging unnecessary purchases. Every suggestion is carefully selected to complement your existing collection, making each purchase more intentional, versatile, and valuable for future journeys.",
  },
  {
    title: "Personalized Recommendations",
    body:
      "No two wardrobes are the same, and neither are Kiru's recommendations. Every suggested item is chosen based on your existing clothing, personal style, destination, and travel plans. Whether you're missing a lightweight jacket for cooler evenings or comfortable footwear for long city walks, every recommendation is tailored to your unique needs.",
  },
  {
    title: "Shop with Purpose",
    body:
      "Rather than promoting fast fashion or impulse buying, Kiru focuses on timeless essentials that integrate naturally into your wardrobe. Each recommendation is evaluated for versatility, allowing a single piece to work across multiple outfits, occasions, and destinations. The goal isn't to buy more—it's to buy better.",
  },
  {
    title: "A Smarter Shopping Experience",
    body:
      "When a purchase truly adds value, Kiru helps you make an informed decision. Compare styles, discover trusted brands, and understand how a new item fits into your existing wardrobe before you buy. By prioritizing compatibility over quantity, every recommendation supports a more thoughtful and sustainable way to travel.",
  },
];
...
const SLIDES = [
  {
    ...
    caption: "Discover wardrobe gaps based on your destination, travel plans, and existing collection.",
    image: "https://images.unsplash.com/photo-1520975914412-1a2f3a1b8b2c?auto=format&fit=crop&w=1400&q=80",
    alt: "Identify what's missing",
    bullets: [],
  },
  {
    section: "02",
  ...
  },
  {
    ...
    caption: "Choose versatile pieces that create multiple outfit combinations across different journeys.",
    image: "https://images.unsplash.com/photo-1503342217505-b0a15d3b4ae2?auto=format&fit=crop&w=1400&q=80",
    alt: "Build more with less",
    bullets: [],
  },
  {
    section: "04",
    title: "Thoughtful Purchases",
    caption: "Invest in clothing that adds lasting value to your wardrobe instead of short-lived trends.",
    image: "https://images.unsplash.com/photo-1512436991641-6745cdb1723f?auto=format&fit=crop&w=1400&q=80",
    alt: "Thoughtful purchases",
    bullets: [],
  },
];
...
function FooterSection() {
  ...
  return (
    <section id="shopping-image-slider" className="relative overflow-hidden bg-charcoal text-white">
