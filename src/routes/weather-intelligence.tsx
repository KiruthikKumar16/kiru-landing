  ...
  return (
    <section id="top" className="relative h-[100svh] min-h-[560px] w-full overflow-hidden">
      <img
        ...
        alt="Traveler checking weather on phone while packing"
...
const OVERVIEW_BLOCKS = [
  {
    title: "Overview",
    body:
      "The weather can change in an instant, but your travel plans shouldn't have to. Kiru's Weather Intelligence combines real-time forecasts with your wardrobe and itinerary to recommend outfits that are comfortable, practical, and perfectly suited to the conditions ahead. From sunny afternoons to unexpected rain, every recommendation is designed to keep you prepared throughout your journey.",
  },
  {
    title: "Forecast-Driven Recommendations",
    body:
      "Every outfit begins with the latest weather information. Kiru continuously analyzes temperature, humidity, precipitation, wind conditions, and UV levels to ensure your clothing choices match the environment you'll experience. Whether you're facing summer heat or winter snow, every recommendation is built around the forecast.",
  },
  {
    title: "Ready for Changing Conditions",
    body:
      "Travel often means experiencing unpredictable weather. Kiru monitors forecast updates before and during your trip, adjusting outfit suggestions whenever conditions change. Layering recommendations, alternative outfits, and weather-specific essentials help you stay comfortable without overpacking.",
  },
  {
    title: "Comfort in Every Climate",
    body:
      "From tropical beaches and desert landscapes to alpine mountains and bustling cities, every destination presents unique environmental challenges. Kiru understands regional climates and seasonal variations, recommending clothing that balances comfort, functionality, and personal style wherever your journey takes you.",
  },
];
...
const SLIDES = [
  {
    ...
    caption: "Monitor real-time forecasts to build recommendations around current and upcoming conditions.",
    image: "https://images.unsplash.com/photo-1521334884684-d80222895322?auto=format&fit=crop&w=1400&q=80",
    alt: "Live weather analysis",
    bullets: [],
  },
  {
    section: "02",
    title: "Climate-Aware Styling",
    caption: "Match every outfit to temperature, humidity, precipitation, and seasonal changes.",
    image: "https://images.unsplash.com/photo-1512436991641-6745cdb1723f?auto=format&fit=crop&w=1400&q=80",
    alt: "Climate aware styling",
    bullets: [],
  },
  {
    section: "03",
    title: "Adaptive Recommendations",
    caption: "Receive updated outfit suggestions as forecasts change throughout your trip.",
    image: "https://images.unsplash.com/photo-1521334884684-d80222895322?auto=format&fit=crop&w=1400&q=80",
    alt: "Adaptive recommendations",
    bullets: [],
  },
  {
    section: "04",
    title: "Prepared for Every Season",
    caption: "Travel confidently with clothing selected for every climate and destination.",
    image: "https://images.unsplash.com/photo-1512436991641-6745cdb1723f?auto=format&fit=crop&w=1400&q=80",
    alt: "Prepared for every season",
    bullets: [],
  },
];
...
function FooterSection() {
  ...
  return (
    <section id="weather-image-slider" className="relative overflow-hidden bg-charcoal text-white">
